...
const Header = () => {
  ...
  const underlineClasses = (path: string) => {
    const isActive = isActivePath(path);
    return `absolute -bottom-1 left-0 w-full h-0.5 bg-red-600 dark:bg-red-400 transform transition-transform ${isActive ? 'scale-x-100' : 'scale-x-0 group-hover:scale-x-100'
      }`;
  };
          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden lg:block">
              <div className="flex items-center space-x-8">
                ...
                {/* CTA Button */}
                <button onClick={() => openBookingModal?.()} className="bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white px-8 py-3 rounded-full text-sm font-bold uppercase tracking-wide shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200">
                  Book Now
                </button>
            ...
            <div className="flex flex-col h-full overflow-y-auto" style={{ height: 'calc(100vh - 92px)' }}>
              <div className="flex-1 px-6 py-8">
                ...
                <div className="mt-8 p-6 bg-gradient-to-r from-red-50 to-emerald-50 dark:from-red-900/20 dark:to-emerald-900/20 rounded-2xl">
                  ...
                  <button
                    onClick={() => { toggleMenu(); openBookingModal?.(); }}
